...
lvmmodel_data_available = 'LVMMODEL' in os.environ
...
class TestIO(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.origEnv = dict(PIXPROD = None, LVM_SPECTRO_SIM = None)
        cls.testEnv = dict(
            PIXPROD = 'test',
    ...
    @unittest.skipUnless(lvmmodel_data_available, 'The lvmmodel data/ directory was not detected.')
