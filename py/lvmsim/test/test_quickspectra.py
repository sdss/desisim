...
import numpy as np
from lvmsim.scripts import quickspectra
import lvmspec.io
...
class TestQuickSpectra(unittest.TestCase):
    ...
    def test_quickspectra(self):
        ...
        sp1 = lvmspec.io.read_spectra(self.outspec1)
        sp2 = lvmspec.io.read_spectra(self.outspec2)
...
def test_suite():
    """Allows testing of only this module with the command::
        ...
        python setup.py test -m lvmsim.test.test_quickspectra
    """
