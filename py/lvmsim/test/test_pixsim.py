...
from lvmsim import pixsim
import lvmsim.scripts.pixsim
...
class TestPixsim(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.testEnv = dict(
            ...
            LVM_SPECTRO_DATA = os.path.join(cls.testDir,'spectro','sim', 'test'),
            )
    ...
    @unittest.skipUnless(desi_templates_available, 'The DESI templates directory ($LVM_ROOT/spectro/templates) was not detected.')
    ...
    def test_parse(self):
        ...
        args = lvmsim.scripts.pixsim.parse(opts)
    ...
    def test_expand_args(self):
        ...
        args = lvmsim.scripts.pixsim.parse(opts)
        self.assertEqual(args.rawfile, lvmspec.io.findfile('raw', night, expid))
