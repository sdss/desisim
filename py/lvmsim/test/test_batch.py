...
from lvmsim.batch.pixsim import batch_newexp, batch_pixsim
...
class TestBatch(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._LVM_SPECTRO_SIM = os.getenv('LVM_SPECTRO_SIM')
        self.testdir = 'test-jkhasnqwezzcqhehadzx'
        os.environ['PIXPROD'] = 'test'
        os.environ['LVM_SPECTRO_SIM'] = self.testdir+'/sim'
        os.environ['LVM_SPECTRO_DATA'] = self.testdir+'/sim/test'
    ...
    def tearDown(self):
        ...
        if self._LVM_SPECTRO_SIM is not None:
            os.environ['LVM_SPECTRO_SIM'] = os.getenv('LVM_SPECTRO_SIM')
