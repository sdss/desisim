...
def parse(options=None):
    ...
    if 'LVM_ROOT' in os.environ:
        _default_flatfile = os.path.join(os.getenv('LVM_ROOT'),
...
def main(args=None):
    ...
    sim, fibermap = \
        lvmsim.simexp.simflat(args.flatfile, nspec=args.nspec, nonuniform=args.nonuniform)
    ...
    lvmsim.io.write_simspec(sim, None, fibermap, None, args.expid, args.night,
