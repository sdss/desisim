...
from lvmsim.io import empty_metatable
...
class EMSpectrum(object):
    ...
    def __init__(self, minwave=3650.0, maxwave=7075.0, cdelt_kms=20.0, log10wave=None):
        ...
        recombfile = resource_filename('lvmsim', 'data/recombination_lines.ecsv')
        forbidfile = resource_filename('lvmsim', 'data/forbidden_lines.ecsv')
        forbidmogfile = resource_filename('lvmsim','data/forbidden_mogs.fits')
...
class GALAXY(object):
    ...
    def __init__(self, objtype='ELG', minwave=3600.0, maxwave=10000.0, cdelt=0.2,
        ...
        from lvmsim import pixelsplines as pxs
        ...
        if baseflux is None or basewave is None or basemeta is None:
            from lvmsim.io import read_basis_templates
    ...
    def make_galaxy_templates(self, nmodel=100, zrange=(0.6, 1.6), magrange=(21.0, 23.5),
        ...
        Args:
          ...
          input_meta (astropy.Table): *Input* metadata table with the following
            ...
            SNE_RFLUXRATIO columns.  See lvmsim.io.empty_metatable for the
        ...
        if self.normline is not None:
            ...
            from lvmsim.templates import EMSpectrum
    ...
    def make_star_templates(self, nmodel=100, vrad_meansig=(0.0, 200.0),
        ...
        Args:
          ...
          input_meta (astropy.Table): *Input* metadata table with the following
            ...
            specified by self.normfilter).  See lvmsim.io.empty_metatable for
...
class QSO():
    ...
    def __init__(self, minwave=3600.0, maxwave=10000.0, cdelt=0.2, wave=None,
        ...
        from speclite import filters
        from lvmsim.io import find_basis_template
        from lvmutil.log import get_logger
        from lvmsim import lya_mock_p1d as lyamock
    ...
    def make_templates(self, nmodel=100, zrange=(0.5, 4.0), rmagrange=(20.0, 22.5),
        ...
        Args:
          ...
          input_meta (astropy.Table): *Input* metadata table with the following
            ...
            self.normfilter).  See lvmsim.io.empty_metatable for the required
        ...
        if uniform:
            from lvmutil.stats import perc
...
def specify_starparams_dict(templatetype,vrad_meansig=None,
    ...
    Args:
        ...
        * input_meta (astropy.Table): *Input* metadata table with the following
                   ...
                   See lvmsim.io.empty_metatable for the required data type
